...
select 2 as id, {{ array_construct(["0", "4"]) }} as array_col
"""


models__array_append_actual_sql = """
select 1 as id, {{ array_append(array_construct(["1","2","3"]), "4") }} as array_col union all
select 2 as id, {{ array_append(array_construct(["0"]), "4") }} as array_col
"""
...
select 2 as id, {{ array_concat(array_construct(["0"]), array_construct(["2"])) }} as array_col union all
select 3 as id, {{ array_concat(array_construct(["3"]), array_construct(["0"])) }} as array_col
"""
